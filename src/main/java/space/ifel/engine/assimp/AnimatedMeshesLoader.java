package space.ifel.engine.assimp;
...
import space.ifel.engine.graph.animation.Animation;
...
public class AnimatedMeshesLoader extends StaticMeshesLoader {
    ...
    public static AnimatedGameItem loadAnimGameItem(String resourcePath, String texturesDir)
            throws Exception {
    ...
    public static AnimatedGameItem loadAnimGameItem(String resourcePath, String texturesDir, int flags)
            throws Exception {
        ...
        Matrix4f rootTransfromation = AnimatedMeshesLoader.toMatrix(aiRootNode.mTransformation());
        ...
        AnimatedGameItem item = new AnimatedGameItem(meshes, animations);
