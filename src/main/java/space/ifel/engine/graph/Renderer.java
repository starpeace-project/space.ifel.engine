package space.ifel.engine.graph;

import org.joml.Matrix4f;
import org.joml.Vector3f;
import org.joml.Vector4f;
import space.ifel.engine.Scene;
import space.ifel.engine.SceneLight;
import space.ifel.engine.Utils;
import space.ifel.engine.Window;
import space.ifel.engine.graph.animation.AnimatedFrame;
import space.ifel.engine.graph.animation.AnimatedGameItem;
import space.ifel.engine.graph.lights.DirectionalLight;
import space.ifel.engine.graph.lights.PointLight;
import space.ifel.engine.graph.particles.IParticleEmitter;
import space.ifel.engine.graph.shadow.ShadowCascade;
import space.ifel.engine.graph.shadow.ShadowRenderer;
import space.ifel.engine.items.GameItem;
import space.ifel.engine.items.SkyBox;
